...
export default defineConfig({
	...
	integrations: [
		...
		htmlMinifier({
			...
			collapseInlineTagWhitespace: true, // aggressive collapse
			...
			mergeScripts: false,
			minifyCSS: true,
			minifyJS: true, // using terser
			minifyURLs: true,
			minifySVG: false, // causes some issues with svg icons
			noNewlinesBeforeTagClose: true,
			partialMarkup: false, // not fragments
			preserveLineBreaks: false,
			preventAttributesEscaping: false, // may lead to XSS vulnerabilities
			processConditionalComments: true,
			removeAttributeQuotes: false, // HTML spec recommends always using quotes
			removeComments: true,
			removeEmptyAttributes: true,
			removeEmptyElements: false, // yeet svg
			removeOptionalTags: false, // may lead to unexpected rendering
			removeRedundantAttributes: true,
			removeScriptTypeAttributes: true,
			removeStyleLinkTypeAttributes: true,
			removeTagWhitespace: false, // result in invalid HTML
			sortAttributes: false,
			sortClassNames: false,
			trimCustomFragments: false, // not fragments
